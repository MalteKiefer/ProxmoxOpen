...
import app.proxmoxopen.data.api.ProxmoxHttpException
import app.proxmoxopen.data.api.ServerConnection
    ...
    override suspend fun login(
        ...
        when (credentials) {
            ...
            is Credentials.UserPassword -> {
                ...
                try {
                    val proxmoxClient = app.proxmoxopen.data.api.ProxmoxApiClient(
                        http = client,
                        baseUrl = server.baseUrl,
                        authHeader = app.proxmoxopen.data.api.ProxmoxApiClient.Authentication
                            .ApiToken(""),
                    )
