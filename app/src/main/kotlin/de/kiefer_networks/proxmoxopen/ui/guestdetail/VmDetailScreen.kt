            ...
            TopAppBar(
                ...
                actions = {
                    ...
                    de.kiefer_networks.proxmoxopen.core.ui.component.OverflowMenu(listOf(
                        de.kiefer_networks.proxmoxopen.core.ui.component.MenuItem(stringResource(R.string.clone_button), Icons.Outlined.CameraAlt) { onClone() },
                        de.kiefer_networks.proxmoxopen.core.ui.component.MenuItem(stringResource(R.string.migrate_button), Icons.Outlined.Storage) { onMigrate() },
                        ...
                        de.kiefer_networks.proxmoxopen.core.ui.component.MenuItem(stringResource(R.string.delete_confirm), Icons.Outlined.Delete, tint = MaterialTheme.colorScheme.error) { deleteDialog = true },
                    ))
                },
        ...
        st?.let { vm ->
            ...
            val diskSize = if (vm.diskTotal > 0) vm.diskTotal else {
                cfg?.disks?.firstOrNull()?.second?.let { raw ->
                    val sizeStr = de.kiefer_networks.proxmoxopen.ui.format.parseDiskString(raw).size
            ...
            cfg?.disks?.let { disks ->
                if (disks.isNotEmpty()) {
                    ...
                    disks.forEach { (id, raw) ->
                        val parsed = de.kiefer_networks.proxmoxopen.ui.format.parseDiskString(raw)
