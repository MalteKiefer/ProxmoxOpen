            ...
            TopAppBar(
                ...
                actions = {
                    ...
                    de.kiefer_networks.proxmoxopen.core.ui.component.OverflowMenu(listOf(
                        de.kiefer_networks.proxmoxopen.core.ui.component.MenuItem(stringResource(R.string.storage_title), Icons.Outlined.Storage) { val n = state.cluster?.nodes?.firstOrNull()?.name; if (n != null) onStorage(n) },
